...
class GreedyBustersAgent(BustersAgent):
    ...
    def registerInitialState(self, gameState):
        ...
        print"self.distancer ",self.distancer 
    ...
    def chooseAction(self, gameState):
        ...
        for i, c in enumerate(MaxBelief):
            if livingGhostPositionDistributions[i][c] >= MaxBeliefgoalProbability:
                #print"coordinate",c
                #print"index",index
                #print"goalProbablity",MaxBeliefgoalProbability
                
                GhostPositionDistribution = livingGhostPositionDistributions[i][c]
        ...
        for action in legal:
            ...
            nextSteps.append((self.distancer.getDistance(nextPosition, MaxBeliefCoordinate), action))
